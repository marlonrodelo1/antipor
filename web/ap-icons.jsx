// Lucide-style icons, stroke 1.5, rounded. Inline so the export bundles them.
const Icon = ({ children, size = 24, color = 'currentColor', stroke = 1.5, style = {} }) => (
...
const I = {
  ...
  sparkles:     (p) => <Icon {...p}><path d="M9.94 13.94 9 17l-3.06-1.06L9 14.88 9.94 12l1.06 2.88L14 16l-2.94 1.06z"/><path d="M16 4 17 7l3 1-3 1-1 3-1-3-3-1 3-1z"/></Icon>,
  mic:          (p) => <Icon {...p}><path d="M12 19v3"/><rect width="8" height="13" x="8" y="2" rx="4"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/></Icon>,
  ...
  leaf:         (p) => <Icon {...p}><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96a1 1 0 0 1 1.8.66 11 11 0 0 1-12 16.5"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/></Icon>,
  ...
  calendar:     (p) => <Icon {...p}><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></Icon>,
  trendingUp:   (p) => <Icon {...p}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></Icon>,
  image:        (p) => <Icon {...p}><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></Icon>,
  camera:       (p) => <Icon {...p}><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3z"/><circle cx="12" cy="13" r="3"/></Icon>,
  type:         (p) => <Icon {...p}><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" x2="15" y1="20" y2="20"/><line x1="12" x2="12" y1="4" y2="20"/></Icon>,
  volume:       (p) => <Icon {...p}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></Icon>,
  ...
  apple:        (p) => <Icon {...p}><path d="M12 20.94c1.5 0 2.75 1.06 4 1.06 3 0 6-8 6-12.22A4.91 4.91 0 0 0 17 5c-2.22 0-4 1.44-5 2-1-.56-2.78-2-5-2a4.9 4.9 0 0 0-5 4.78C2 14 5 22 8 22c1.25 0 2.5-1.06 4-1.06Z"/><path d="M10 2c1 .5 2 2 2 5"/></Icon>,
  google:       (p) => <Icon {...p}><circle cx="12" cy="12" r="10"/><path d="M12 8v8"/><path d="M8 12h8"/></Icon>,
  globe:        (p) => <Icon {...p}><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></Icon>,
  bookmark:     (p) => <Icon {...p}><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></Icon>,
  ...
  edit:         (p) => <Icon {...p}><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="m18.5 2.5 a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></Icon>,
  ...
  timer:        (p) => <Icon {...p}><line x1="10" x2="14" y1="2" y2="2"/><line x1="12" x2="15" y1="14" y2="11"/><circle cx="12" cy="14" r="8"/></Icon>,
  ...
  bookOpen:     (p) => <Icon {...p}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2zM22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></Icon>,
